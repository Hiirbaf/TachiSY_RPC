@file:Suppress("PrivatePropertyName", "PropertyName", "MemberVisibilityCanBePrivate", "unused")
...
import com.jery.tachisy_rpc.rpc.Constants.APPLICATION
...
class RPCService(var token: String,) {
     ...
     * @return
     */
    fun setName(activity_name: String?): RPCService {
     ...
     * @return
     */
    fun setDetails(details: String?): RPCService {
     ...
     * @return
     */
    fun setState(state: String?): RPCService {
        this.state = state
        return this
    }
     ...
     * @return
     */
    fun setLargeImage(large_image: String?): RPCService {
        if (large_image != null) {
    ...
    fun setLargeImage(large_image: String,context: Context): RPCService {
     ...
     * @return
     */
    fun setSmallImage(small_image: String?): RPCService {
        if (small_image != null) {
     ...
     * @return
     */
    fun setStartTimestamps(start_timestamps: Long?): RPCService {
     ...
     * @return
     */
    fun setStopTimestamps(stop_timestamps: Long?): RPCService {
    ...
    fun setType(type: Int): RPCService {
        if (type in 0..5)
            this.type = type
        else this.type = 0
        return this
    ...
    * @return
    */
    fun setStatus(status: String?): RPCService {
        this.status = status
        return this
    }
     ...
     * @return
     */
    fun setButton1(button1_Text: String?): RPCService {
     ...
     * @return
     */
    fun setButton2(button2_text: String?): RPCService {
     ...
     * @return
     */
    fun setButton1URL(url: String?): RPCService {
     ...
     * @return
     */
    fun setButton2URL(url: String?): RPCService {
        url?.let { button_url.add(it) }
        return this
    }
