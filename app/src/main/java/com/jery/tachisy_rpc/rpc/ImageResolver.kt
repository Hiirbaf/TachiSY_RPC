...
import com.jery.tachisy_rpc.BuildConfig
import com.jery.tachisy_rpc.utils.Prefs
import com.jery.tachisy_rpc.utils.Prefs.RPC_USE_CUSTOM_WEBHOOK
import com.jery.tachisy_rpc.utils.Prefs.RPC_USE_LOW_RES_ICON
import okhttp3.*
...
class ImageResolver {
    ...
    fun resolveImageFromUrl(large_image_url: String): String? {
        ...
        val request: Request = Request.Builder()
            .url(BuildConfig.GOOGLE_IMAGE_API + large_image_url)
            .build()
